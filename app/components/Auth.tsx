...
/** Returns the screenshot path for the current theme. Matches the same
 *  helper in the Onboarding component so the landing showcase and the
 *  post-login onboarding tour always render the same asset per section. */
function shot(
...
type ShowcaseKind = "home" | "planner" | "progress" | "mindmap";
const SHOWCASE: { kind: ShowcaseKind; title: string; desc: string }[] = [
  {
    kind: "home",
  ...
  },
  {
    ...
    desc: "Streaks, completion stats and per-folder breakdowns so you always know what's left to do.",
  },
  {
    kind: "mindmap",
