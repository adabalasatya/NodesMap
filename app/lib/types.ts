...
export interface Task {
  id: string;
  title: string;
  /** Default description used on every day the task shows up. */
  description?: string;
  /** Per-day overrides — key is YYYY-MM-DD, value replaces
   *  `description` on that specific day only. Useful for daily/weekly
   *  tasks where the user wants a different note on a specific date. */
